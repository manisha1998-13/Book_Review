...
<body>
        ...
        <li class="current"><a href="publisher.jsp">Publisher</a></li>
        ...
        <br/>
        <center><p><font color="white" size="5"> Publisher Login</font></p></center>

        <p><center>

         <form name="myform" action="publisheract.jsp" method="post">
         <table border="0" >
