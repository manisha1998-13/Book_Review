...
<body>
    <div id="main">
        ...
        <li class="current"><a href="addpublisher.jsp">Add Publisher</a></li>
        <li><a href="viewpublishers.jsp">View Publisher</a></li>
        <li><a href="viewusers.jsp">View Users</a></li>
        <li><a href="adminviewbooks.jsp">View Books</a></li>
    ...
    <form name="myform" action="addpublisheract.jsp" method="post" onsubmit="return validateform()" >
    <center>
<table align="center">
    
    <br>
    <center><p><font size="6" color="white">&nbsp;&nbsp;&nbsp;&nbsp; Add Publisher </font></p></center>
           ...
           <tr>
            ...
            <tr>
              ...
              <td>
                  ...
                  <td><input type="submit" value="Add" style="height:30px; width:70px" />
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
